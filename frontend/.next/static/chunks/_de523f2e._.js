...
const SearchBar = (param)=>{
    let { onSearch, debounceMs = 500 } = param;
    _s();
    const [query, setQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const debouncedQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDebounce$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebounce"])(query, debounceMs);
...
_s(SearchBar, "hfDiyK416U2HeNz3pW91eVVGyoc=", false, function() {
    return [
...
function SearchPage() {
    ...
    const { data: searchResults, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMovies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchMovies"])(searchQuery, currentPage, searchEnabled);
    const addToFavorites = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMovies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAddToFavorites"])({
        "SearchPage.useAddToFavorites[addToFavorites]": (errorMessage)=>showError(errorMessage)
    }["SearchPage.useAddToFavorites[addToFavorites]"]);
    const removeFromFavorites = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMovies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRemoveFromFavorites"])({
        "SearchPage.useRemoveFromFavorites[removeFromFavorites]": (errorMessage)=>showError(errorMessage)
    }["SearchPage.useRemoveFromFavorites[removeFromFavorites]"]);
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchPage.useMemo[totalPages]": ()=>{
            if (!(searchResults === null || searchResults === void 0 ? void 0 : searchResults.data.totalResults)) return 0;
            const total = parseInt(searchResults.data.totalResults, 10);
            return Math.ceil(total / 10);
        }
    }["SearchPage.useMemo[totalPages]"], [
        searchResults === null || searchResults === void 0 ? void 0 : searchResults.data.totalResults
    ]);
    const handleSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SearchPage.useCallback[handleSearch]": (query)=>{
    ...
    const toggleFavoriteAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SearchPage.useCallback[toggleFavoriteAction]": async (movie)=>{
    ...
    }["SearchPage.useCallback[toggleFavoriteAction]"], [
        addToFavorites,
        removeFromFavorites
    ]);
    const debouncedToggleFavorite = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDebouncedCallback$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebouncedCallback"])(toggleFavoriteAction, 300);
    const handleToggleFavorite = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SearchPage.useCallback[handleToggleFavorite]": (movie)=>{
            debouncedToggleFavorite(movie);
        }
    }["SearchPage.useCallback[handleToggleFavorite]"], [
    ...
    const handlePageChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SearchPage.useCallback[handlePageChange]": (page)=>{
    ...
    }["SearchPage.useCallback[handlePageChange]"], [
        totalPages
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                !isLoading && !error && (searchResults === null || searchResults === void 0 ? void 0 : searchResults.data.movies.length) === 0 && !searchQuery && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "text-center py-12",
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-muted-foreground",
                            children: "Search for your favorite movies and add them to your favorites"
                        }, void 0, false, {
                            fileName: "[project]/src/app/page.tsx",
                            lineNumber: 125,
                            columnNumber: 13
                ...
                !isLoading && !error && (searchResults === null || searchResults === void 0 ? void 0 : searchResults.data.movies) && searchResults.data.movies.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6",
                            children: searchResults.data.movies.filter((movie, index, self)=>// Remove duplicates based on imdbID
                                index === self.findIndex((m)=>m.imdbID === movie.imdbID)).map((movie, index)=>{
                                var _movie_isFavorite;
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MovieCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    movie: movie,
                                    isFavorite: (_movie_isFavorite = movie.isFavorite) !== null && _movie_isFavorite !== void 0 ? _movie_isFavorite : false,
...
_s(SearchPage, "MTdwMtkuOqSwLGceub7yEdQPewA=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMovies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchMovies"],
...
//# sourceMappingURL=_de523f2e._.js.map